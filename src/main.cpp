...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MukasCoin: 1 days
static const int64 nTargetSpacing = 120; // MukasCoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1508428213; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1508428213;
            block.nNonce   = 0;
        }
